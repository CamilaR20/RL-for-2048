...
class DQN(nn.Module):
    def __init__(self, observation_shape, n_actions):
        ...
        self.layer1 = nn.Conv2d(observation_shape[0], 64, kernel_size=2, stride=1, padding='valid')
        self.layer2 = nn.Conv2d(64, 128, kernel_size=2, stride=1, padding='valid')
        self.layer3 = nn.Flatten()
        self.layer4 = nn.Linear(512, 256)
        self.layer5 = nn.Linear(256, n_actions)
        # self.layer1 = nn.Conv2d(observation_shape[0], 64, kernel_size=3, stride=1, padding='same')
        # self.layer2 = nn.Conv2d(64, 128, kernel_size=3, stride=1, padding='same')
        # self.layer3 = nn.Conv2d(128, 256, kernel_size=3, stride=1, padding='same')
...
if __name__ == "__main__":
    ...
    device = "cpu" # CPU ended up being faster for this case
    ...
    for i_episode in range(num_episodes):
        print('Episode {} running...'.format(i_episode))
